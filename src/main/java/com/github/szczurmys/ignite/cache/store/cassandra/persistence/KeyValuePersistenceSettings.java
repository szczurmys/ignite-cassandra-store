...
package com.github.szczurmys.ignite.cache.store.cassandra.persistence;
...
import com.github.szczurmys.ignite.cache.store.cassandra.common.CassandraHelper;
...
public class KeyValuePersistenceSettings implements Serializable {
    ...
    /** TTL (time to leave) for rows inserted into Cassandra table <a href="https://docs.datastax.com/en/cql/3.1/cql/cql_using/use_expire_c.html">Expiring data</a>. */
    private Integer ttl;
    ...
    /** Cassandra table creation options <a href="https://docs.datastax.com/en/cql/3.0/cql/cql_reference/create_table_r.html">CREATE TABLE</a>. */
    private String tblOptions;

    /** Cassandra keyspace creation options <a href="https://docs.datastax.com/en/cql/3.0/cql/cql_reference/create_keyspace_r.html">CREATE KEYSPACE</a>. */
